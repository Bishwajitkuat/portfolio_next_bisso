...
export default function ProjectCard({ project }: ProjectCardPros) {
  ...
  return (
    <li className=" grid md:grid-cols-2 shadow-lx rounded-xl bg-gradient-to-tr from-blue-200 to-[#5651e56f] p-6 gap-6 hover:shadow-2xl hover:scale-105 ease-in duration-300  ">
      <Image
